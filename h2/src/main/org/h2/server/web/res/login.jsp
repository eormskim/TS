...
<form name="login" method="post" action="login.do?jsessionid=${sessionId}" id="login">
    ...
    <table class="login" cellspacing="0" cellpadding="0">
        ...
        <tr class="login">
            ...
            <td class="login">
                ...
                <input type="button" class="button" value="${text.login.save}"
        ...
        <tr class="login">
            ...
            <td class="login">
                ...
                &nbsp;
                <input type="button" class="button" value="${text.login.testConnection}"
    ...
    <div id="url" style="display: none">
        ...
        <p>
            ...
            <a target="_blank" href="https://h2database.com/html/tutorial.html#creating_new_databases">if you have a
                permission</a>.
        ...
        <p>
            For more information, see <a target="_blank" href="https://h2database.com/html/features.html#database_url">Database
            URL Overview</a>.
        </p>
    </div>
