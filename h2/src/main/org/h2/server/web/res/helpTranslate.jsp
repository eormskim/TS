...
<div>
    ...
    <ul>
        <li>Stop the H2 Console
        </li>
        <li>Rename or delete the translation file
        </li>
        <li>Start the H2 Console
        </li>
        <li>Select the source language of your choice
        </li>
        <li>Go to 'Preferences' and click 'Translation'
        </li>
    </ul>
